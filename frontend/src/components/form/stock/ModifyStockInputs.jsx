...
export default function ModifyStockInputs() {
    ...
    const [isSortie, setIsSortie] = useState(false)
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const item_data = await stockData.getPiece(stock_data.piece_id)
                setNomPiece(item_data.nom_piece)
                ...
                const stock_carton_all = await stockData.getCartonStock(id)
                ...
                const stock_lot_all = await stockData.getLotStock(id)
        ...
        <>
            <div className="flex justify-center">
                {loading ? (
                    ...
                    <ComponentCard className="md:w-1/2 w-full" title="Modifier Stock">
                        <div className="space-y-5">
                            ...
                            <div className="text-center">
                                <span className="text-sm font-semibold">Modification de Stock</span>
                            </div>
                            <div className="space-y-3">
                                ...
                                <div>
                                    <Label>Choisir le type <span className="text-red-700">*</span></Label>
                                    <Select
                                                                ...
                                                                {isEntree ? (
                                                                    ...
                                                                    <>
                                                                        {isSortie ? (
                                                                            <>
                                                                                <div className="w-full flex justify-center items-center">
                                                                                    <button className="w-1/2 flex items-center justify-between bg-red-400 p-2 rounded-2xl"
