...
const pool = createPool({
   ...
   export const findMerchant =  async (req,res)=>{
        // const {sn} = req.body
        try {
            const query = 'SELECT POINT_MARCHAND.POINT_MARCHAND,TPE.SERIAL_NUMBER,TPE.TPE,POINT_MARCHAND.BANQUE,POINT_MARCHAND.NUM_ORANGE,POINT_MARCHAND.NUM_MTN, POINT_MARCHAND.NUM_MOOV  '+
