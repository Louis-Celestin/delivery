...
export default function AllDemandesSupportList() {
    ...
    useEffect( ()=>{
        const fetchDemandeForms = async () =>{
            ...
            try{
                ...
                setDemandeForms(demandesSupport)
    ...
    const titleTemplate = (demandeForms) =>{
        let title = '';
        let linkSee = `/demande-support-details/${demandeForms.id_demande}`;
    ...
    const actionTemplate = (demandeForms) =>{
        let linkSee = `/demande-support-details/${demandeForms.id_demande}`;
        let linkModify = `/modifier-demande-support/${demandeForms.id_demande}`
